...
export default function ManagerSettings() {
  ...
  const styles = useMemo(() => ({
    container: { padding: "32px", background: "#f8fafc", minHeight: "100vh" },
    header: { marginBottom: 32, maxWidth: 1200, margin: "0 auto 32px auto" },
    title: { fontSize: 28, fontWeight: 900, color: "#0f172a", margin: 0 },
    ...
    card: { background: "#fff", borderRadius: 16, padding: 24, boxShadow: "0 1px 3px rgba(0,0,0,0.05), 0 1px 2px rgba(0,0,0,0.1)", border: "1px solid #e2e8f0", display: "flex", flexDirection: "column" },
    cardHeader: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20, paddingBottom: 16, borderBottom: "1px solid #f1f5f9" },
    h3: { margin: 0, fontSize: 16, fontWeight: 700, color: "#1e293b", textTransform: "uppercase", letterSpacing: "0.025em" },
    
    // Inputs & ReadOnly
    readOnlyBox: { background: "#f8fafc", padding: "10px 14px", borderRadius: 8, border: "1px solid #e2e8f0", fontSize: 14, color: "#334155", fontWeight: "600", minHeight: "42px", display: "flex", alignItems: "center" },
    input: { width: "100%", padding: "10px 14px", borderRadius: 8, border: "2px solid #6366f1", outline: "none", fontSize: 14, background: "#fff", boxSizing: "border-box", fontWeight: "500" },
    label: { fontSize: 12, fontWeight: 700, color: "#64748b", marginBottom: 6, display: "block", textTransform: "uppercase" },
    
    // Buttons
    btnPrimary: { padding: "8px 16px", borderRadius: 8, background: "#0f172a", color: "#fff", border: "none", cursor: "pointer", fontWeight: 600, fontSize: 13, transition: "0.2s" },
    btnOutline: { padding: "8px 16px", borderRadius: 8, background: "transparent", color: "#334155", border: "1px solid #cbd5e1", cursor: "pointer", fontWeight: 600, fontSize: 13 },
    btnLink: { background: "none", border: "none", color: "#6366f1", fontWeight: 600, cursor: "pointer", fontSize: 13 },

    // Internal Grids
    grid2: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 },
    
    // Modal
    modalOverlay: { position: "fixed", inset: 0, background: "rgba(15, 23, 42, 0.6)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1100, backdropFilter: "blur(2px)" },
    modal: { background: "#fff", padding: 28, borderRadius: 16, width: "100%", maxWidth: 400, boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.25)" },
    toast: { position: "fixed", bottom: 24, right: 24, background: "#0f172a", color: "#fff", padding: "12px 24px", borderRadius: 10, fontWeight: 600, boxShadow: "0 10px 15px -3px rgba(0, 0, 0, 0.1)" }
  }), []);
